...
public class OPAKPSPublicSoap
{
    ...
    public OPAKPSPublicSoap(){}

    public OPAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OPAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OPAExtendedSoapSerializationEnvelope envelope= new OPAExtendedSoapSerializationEnvelope(OPAExtendedSoapSerializationEnvelope.VER11);
