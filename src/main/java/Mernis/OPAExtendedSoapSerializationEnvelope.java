...
public class OPAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OPADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OPAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OPADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OPADateTimeConverter dateTimeConverter = new OPAStandardDateTimeConverter();

    public OPAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OPAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OPAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OPAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OPAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OPAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
